...
class ProjectsPaymentRequestForm extends StatefulWidget {
  const ProjectsPaymentRequestForm({super.key});

  @override
  State<ProjectsPaymentRequestForm> createState() => _ProjectsPaymentRequestFormState();
}

class _ProjectsPaymentRequestFormState extends State<ProjectsPaymentRequestForm> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const MyAppBar(appname: 'Payment Request Form'),
      body: LayoutBuilder(
            ...
            child: Column(
              ...
              children: [
                ListTile(
                  title: Center(
                    child: Text(
                      'Select Project/Location/Work type Material',
